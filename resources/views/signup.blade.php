...
<div class="inloggen">
    <form class="form" action="{{ route('item.store') }}" method="post">
        ...
        <div class="inputForm">
            ...
            <input type="password" class="input" placeholder="Enter your Email" name="email" required>
        ...
        <div class="flex-row">
            ...
            <span class="span">Forgot User?</span>
        </div>
        <button class="button-submit" name="signup">Sign Up</button>
        <p class="p">All an account? <span class="span"><a href="/inloggen">Sign In</a></span></p>
