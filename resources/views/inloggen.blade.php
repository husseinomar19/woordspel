@extends('layout')
    ...
    <div class="flex-column">
      ...
      <div class="inputForm">
        ...
        <input type="password" class="input" placeholder="Enter your Email" name="email">
    ...
    <button class="button-submit" name="inlog">Sign In</button>
    <p class="p">Don't have an account? <span class="span"><a href="/signup">Sign Up</a></span>
